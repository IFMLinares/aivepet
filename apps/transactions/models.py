...
class Transaction(models.Model):
    ...
    receiving_customer = models.ManyToManyField(ReceivingCustomer, blank=True, null=True)
    ...
    Wineries = models.ManyToManyField(Winerie, blank=True, null=True)
    ...
    destinations = models.ManyToManyField(Destination, blank=True, null=True)
